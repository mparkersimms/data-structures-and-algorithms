...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(function(value){
    answerArray.push(Math.pow(value, 3));
  });
  return answerArray;
};
...
------------------------------------------------------------------------------------------------ */
const d = { fullName: 'Octavia Butler' };
...
------------------------------------------------------------------------------------------------ */
const e = [{ fullName: 'Octavia Butler' }, { fullName: 'Ray Bradbury' }, { fullName: 'Kurt Vonnegut' }];
...
setStatusAsAuthor(e);
console.log(e[0].isAuthor);
console.log(e[1].isAuthor);
console.log(e[2].isAuthor);
