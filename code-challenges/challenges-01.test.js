...
------------------------------------------------------------------------------------------------ */
var stringArray = ['hi', 'how', 'are', 'you'];
...
const fourthArray = ['hello', '301', 'students'];

const speaker = (words, callback) => {
  // Solution code here...
  const newArr = [];
  fourthArray.forEach(function(word){
